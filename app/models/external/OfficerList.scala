...
case class Officer(nameElements: Option[Name],
                   role: String,
...
object Officer {
  implicit val formatModel: Reads[Officer] = (
    (__ \ "name_elements").readNullable[Name](Name.normalizeNameReads) and
      (__ \ "officer_role").read[String] and
      (__ \ "resigned_on").readNullable[DateTime] and
      (__ \ "appointment_link").readNullable[String]
    ) (Officer.apply _)

  val seqReads: Reads[Seq[Officer]] = (json: JsValue) => Json.fromJson[Seq[Officer]](json)
}
